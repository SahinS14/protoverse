...
conn = get_conn()
cur = conn.cursor()
 # Let's get the satellite pair I used before for testing
...
now = datetime.now(timezone.utc)
 ...
 # Propagation will be performed up to the current "now" moment
...
v2 = (r2_f - r2) / 1.0
 ...
 # t* calculation
 # Here, since we are only testing, we used the analytical method
 # Later, in the real stage, the refined method written in conjunction.py will be used
r = r2 - r1
v = v2 - v1
